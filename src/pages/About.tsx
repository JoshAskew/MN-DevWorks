            ...
            <ul className="core-values-list-items slide-in">
              <li className="core-values-list-item slide-in">
                <div className="CV-list-item-header slide-in">
                  <img src={BreakpointIcon} className="blur-icon slide-in" />
              ...
              <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" />Collaboration</span><br></br><p className="CV-list-item-text slide-in">
              ...
              <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" />Simplicity & Efficiency</span><br></br><p className="CV-list-item-text slide-in">
              ...
              <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" />Integrity</span><br></br><p className="CV-list-item-text slide-in">
              ...
              <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" />Creativity & Innovation</span><br></br><p className="CV-list-item-text slide-in">
          ...
          <div className="core-values slide-in">
            ...
            <div className="core-values-list slide-in">
              <ul className="core-values-list-items slide-in">
                ...
                <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" />Strategic Planning & Concept Development</span><br></br><p className="CV-list-item-text slide-in">
                ...
                <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" />Wireframing & Prototyping</span><br></br><p className="CV-list-item-text slide-in">
                ...
                <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"><img src={BreakpointIcon} className="blur-icon slide-in" />Design & Development</span><br></br><p className="CV-list-item-text slide-in">
                ...
                <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" /> Quality Assurance & Testing</span><br></br><p className="CV-list-item-text slide-in">
                ...
                <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" /> Launch & Deployment</span><br></br><p className="CV-list-item-text slide-in">
                ...
                <li className="core-values-list-item slide-in"><span className="CV-list-item-header slide-in"> <img src={BreakpointIcon} className="blur-icon slide-in" /> Ongoing Support & Maintenance</span><br></br><p className="CV-list-item-text slide-in">
